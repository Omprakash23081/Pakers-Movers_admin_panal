    ...
    <AdminWrapper>
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-all font-bold">
                    ...
                    <tr key={quote._id} className="hover:bg-white/[0.01] transition-colors group">
                      <td className="px-6 py-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-bold text-white text-base">{quote.firstName} {quote.lastName}</p>
                      ...
                      <td className="px-6 py-6">
                        <div className="space-y-1">
                          ...
                          <p className="flex items-center gap-1.5 text-xs text-muted-foreground italic">
                            <Calendar className="w-3 h-3" /> {new Date(quote.createdAt).toLocaleDateString()}
                          </p>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-6">
                        <select 
                          ...
                          className={`px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-lg border bg-transparent cursor-pointer outline-none transition-all
                            ${quote.status === 'pending' ? 'text-yellow-500 border-yellow-500/20' : 
                              quote.status === 'converted' ? 'text-emerald-500 border-emerald-500/20' : 
                              'text-blue-500 border-blue-500/20'}`}
                        >
                          <option value="pending" className="bg-[#0B1120]">Pending</option>
                          <option value="contacted" className="bg-[#0B1120]">Contacted</option>
                          <option value="converted" className="bg-[#0B1120]">Converted</option>
